...
import 'setting_copy_model.dart';
export 'setting_copy_model.dart';

class SettingCopyWidget extends StatefulWidget {
  const SettingCopyWidget({super.key});

  @override
  State<SettingCopyWidget> createState() => _SettingCopyWidgetState();
}

class _SettingCopyWidgetState extends State<SettingCopyWidget> {
  late SettingCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingCopyModel());
